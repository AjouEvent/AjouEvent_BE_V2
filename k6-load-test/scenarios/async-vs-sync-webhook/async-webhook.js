 ...
 *
 * 실행:
 *   ./load-test/run.sh load-test/scenarios/async-vs-sync-webhook/async-webhook.js single
 *   ./load-test/run.sh load-test/scenarios/async-vs-sync-webhook/async-webhook.js ramp
 *   ./load-test/run.sh load-test/scenarios/async-vs-sync-webhook/async-webhook.js rate
 */
