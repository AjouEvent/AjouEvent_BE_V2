...
public interface ClubEventControllerDocs {
    ...
    @Operation(
        summary = "공지사항 상세 조회",
        description = """
            공지사항 상세 정보를 반환합니다. 비인증 사용자도 조회 가능하며 IP 기반으로 조회수가 증가합니다.
    ...
    ResponseEntity<ClubEventDetailResponse> getEventDetail(
        Long eventId, @AuthOptional Member member, HttpServletRequest request);

    @Operation(
        summary = "타입별 공지사항 조회",
        description = """
            특정 타입의 공지사항 목록을 페이징하여 반환합니다. keyword 파라미터로 제목 검색 가능.
    ...
    ResponseEntity<SliceResponse<ClubEventResponse>> getEventTypeList(
        String type, String keyword, Pageable pageable, @AuthOptional Member member);
    ...
    ResponseEntity<SliceResponse<ClubEventResponse>> getSubscribedEvents(
        Pageable pageable, @AuthOptional Member member, String keyword);
    ...
    ResponseEntity<SliceResponse<ClubEventWithKeywordResponse>> getByKeyword(
        String keyword, @AuthUser Member member, Pageable pageable);
    ...
    ResponseEntity<Void> likeEvent(Long eventId, @AuthUser Member member);
    ...
    ResponseEntity<Void> cancelLikeEvent(Long eventId, @AuthUser Member member);

    @Operation(
        summary = "찜한 공지사항 목록 조회",
        description = """
            로그인한 사용자가 찜한 공지사항 목록을 반환합니다. type, keyword로 필터링 가능.
    ...
    ResponseEntity<SliceResponse<ClubEventResponse>> getLikedEvents(
        String type, String keyword, Pageable pageable, @AuthUser Member member);
}
