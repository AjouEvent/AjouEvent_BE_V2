...
public class NotificationController implements NotificationControllerDocs {
    ...
    @Override
    @GetMapping("/api/notification/topic")
    ...
    @Override
    @GetMapping("/api/notification/keyword")
    ...
    @Override
    @PostMapping("/api/notification/click")
    public ResponseEntity<Void> markNotificationAsRead(
        @RequestBody NotificationClickRequest request, @AuthUser Member member) {
        notificationOrchestrator.markNotificationAsRead(request.pushNotificationId(), member);
