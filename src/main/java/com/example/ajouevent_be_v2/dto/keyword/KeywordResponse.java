...
public record KeywordResponse(
    @Schema(description = "키워드 URL 인코딩 식별자 (URLEncode(koreanKeyword) + '_' + 소프트웨어학과)", example = "%EC%9E%A5%ED%95%99%EA%B8%88_소프트웨어학과")
    String encodedKeyword,

    @Schema(description = "키워드 한글명", example = "장학금")
    String koreanKeyword,

    @Schema(description = "알림 검색에 사용되는 복합 식별자 (koreanKeyword + '_' + topicName)", example = "장학금_소프트웨어학과")
